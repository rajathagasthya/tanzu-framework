...
func main() {
	var OciRegistry = "projects.registry.vmware.com/tanzu_framework"
	var PackagesDirectoryPath = filepath.Join("..", "..", "packaging", "packages")
	var RepoDirectoryPath = filepath.Join("..", "..", "packaging", "repos")
